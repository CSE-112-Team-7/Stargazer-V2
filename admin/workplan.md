...
- Work on user history (`HIGH`): _7 days_
  ...
  - Store: 
    ...
    - Constellation
    - Date/time
- Light/dark mode (`MEDIUM`): _3 days_
  - Figure out what tests are failing and add documentation (`HIGH`)
  - Fix failed tests (`MEDIUM`)
- Sprite following mouse (`LOW`): _1 day_
  - Change custom mouse (have a mouse that has a sprite and mouse)
- Volume control (add to all pages) (`LOW`): _1 day_
- Fix DOM tree (`HIGH`): _7 days_
  - Removing animations (`MEDIUM`)
    - "Just press backspace"
  - Restructre HTML (`HIGH`)
- Language settings (different language support) (`LOW`): _5 day_
- General settings panel (`HIGH`): _2 days_
